      ...
      <div className="mx-auto max-w-[95%] sm:max-w-[90%] relative rounded-xl md:rounded-2xl lg:rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl">
        ...
        <div className="relative z-10 px-4 py-6 sm:px-6 sm:py-8 lg:p-10">
          ...
          >
            ...
            <span className={`inline-flex items-center gap-2 rounded-full bg-white/5 border border-white/10 px-5 py-2 text-xs font-medium uppercase text-[#E39A2E] backdrop-blur-md shadow-lg shadow-black/20 transition-all duration-700 ease-out ${
